...
-- lin big_A = mkA "big" ;
-- lin bike_N = mkN "bike" ;
-- lin bird_N = mkN "shimbiró" ; --TODO: this is plural, what is singular?
-- lin black_A = mkA "black" ;
-- lin blood_N = mkN "blood" ;
-- lin blue_A = mkA "blue" ;
-- lin boat_N = mkN "boat" ;
lin book_N = mkN "búug" ;
lin boy_N = mkN "ínan" ; --masc --wíil (son)
lin bread_N = mkN "rooti" ; --masc/fem
-- lin break_V2 = mkV2 "break" ;
-- lin buy_V2 = mkV2 "buy" ;
lin car_N = mkN "baabuur" ; --masc
lin cat_N = mkN "bisád" ; --fem
